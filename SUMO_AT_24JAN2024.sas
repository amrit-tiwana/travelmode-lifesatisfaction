...
DATA WORK.SUMO_COPY;
	...
	remote_one1 = (transport_mode1 = 9);
	remote_multi1 = (transport_mode1 = 10);
RUN;
...
DATA WORK.SUMO_COPY_MI;
   SET WORK.SUMO_COPY_MI;
   /* Set negative values to zero for specific variables */
   IF adjusted_hhincome < 0 THEN adjusted_hhincome = 0;
   IF Q9_10_1_hhincome_num < 0 THEN Q9_10_1_hhincome_num = 0;
   IF Q9_4_RacialCategory_num < 0 THEN Q9_4_RacialCategory_num = 0;
RUN;
